...
const COMMANDS = {
	...
	"Surprise":
         "Перейди на сайт <u><a href=\"https://mcpromo.ru\" target=\"_blank\"><span class=\"grray\">mcpromo.ru</span></a></u> и введи код доступа: <span class=\"green\">1C-179A6-8B789-D53A8</span><span class=\"grray\">, где A - первая цифра моего дня рождения + 3, B - первая цифра твоего дня рождения + 4, C - крайняя цифра моего дня рождения, D - крайняя цифра твоего дня рождения + 9</span><br><br><a href=\"https://mcpromo.ru\" target=\"_blank\"><img src=\"./Terminal/assets/qr.png\"></a><br><br>Если всё прошло успешно то введи команду <span class=\"green\">Done</span>, иначе <span class=\"orange\">Report</span>",	
	...
	"Done":
         "<span class=\"rose\">C праздником 8 марта!</span></br><img src=\"./Terminal/assets/heart (1).png\">",	
